                            ...
                            if (
                                ...
                                v > 0 && i.currentTranslate > this.minTranslate()
                                    ...
                                    : v < 0 &&
                                      ...
                                      ((f = !1), s.resistance && (i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - v, g))),
        ...
        if (((i.isTouched = !1), (i.isMoved = !1), (i.startMoving = !1), (h = s.followFinger ? (r ? t.translate : -t.translate) : -i.currentTranslate), !s.cssMode))
            if (s.freeMode) {
                ...
                if (s.freeModeMomentum) {
                    ...
                    if (b < t.maxTranslate())
                        s.freeModeMomentumBounce ? (b + t.maxTranslate() < -S && (b = t.maxTranslate() - S), (y = t.maxTranslate()), (C = !0), (i.allowMomentumBounce = !0)) : (b = t.maxTranslate()),
                            s.loop && s.centeredSlides && (T = !0);
                    else if (b > t.minTranslate())
                        s.freeModeMomentumBounce ? (b - t.minTranslate() > S && (b = t.minTranslate() + S), (y = t.minTranslate()), (C = !0), (i.allowMomentumBounce = !0)) : (b = t.minTranslate()),
                            s.loop && s.centeredSlides && (T = !0);
