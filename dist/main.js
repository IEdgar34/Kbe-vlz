...
var send = function send() {
  ...
  var Send = /*#__PURE__*/function () {
    function Send(data) {
      ...
      _defineProperty(this, "_apiKey", "7023015420:AAErko_HZmS7aSKXyBw-mcmcSTfjGQhXEDY");
      _defineProperty(this, "_chatId", "-4536366649");
      _defineProperty(this, "_url", "https://api.telegram.org/bot".concat(this._apiKey, "/sendMessage"));
      /* data = `
          📩 Вам новое сообщение:
          <b>Имя:</b> ${"=("}
          <b>Фамилия:</b> ${"=("}
    ...
    return _createClass(Send, [{
      key: "met",
      value: function () {
        var _met = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var respons, json;
        ...
        function met() {
          return _met.apply(this, arguments);
        }
        return met;
      }()
    }]);
  }();
  var promotion = document.querySelectorAll(".get__info");
  promotion.forEach(function (item) {
    return item.addEventListener("click", function (e) {
      if (e.target && e.target.classList.contains("btn")) {
        var _parent$querySelector;
        var parent = e.target.closest(".data__wrapper");
        var productName = parent.querySelector(".txt").innerText;
        var profilSistem = (_parent$querySelector = parent.querySelector(".profile__sistem")) === null || _parent$querySelector === void 0 ? void 0 : _parent$querySelector.innerText;
  ...
  forms.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      e.preventDefault();
      var parent = e.target.closest(".info__wrapper");
      var t = (_parent$querySelector2 = parent.querySelector(".info__title")) === null || _parent$querySelector2 === void 0 ? void 0 : _parent$querySelector2.innerText;
  ...
  function writeData() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Не указано";
    var phone = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Не указано";
    var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "Не указано";
    var productName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "Не указано";
    var profileSistem = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "Не указано";
    var applicationType = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : "Не указано";
    return {
      name: name,
      phone: phone,
      btntitle: title,
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_sendform__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/sendform */ "./src/js/modules/sendform.js");
...
window.addEventListener("DOMContentLoaded", function () {
  (0,_modules_sendform__WEBPACK_IMPORTED_MODULE_0__.send)();
});
})();
