...
!(function (t, e, n, o) {
    ...
    function i(t, e) {
        ...
        (t && t.isDefaultPrevented()) ||
            ...
            i
                ? ((a = e.selector ? n(e.selector) : t.data ? t.data.items : []), (a = a.length ? a.filter('[data-fancybox="' + i + '"]') : n('[data-fancybox="' + i + '"]')), (s = a.index(o)), s < 0 && (s = 0))
                : (a = [o]),
                ...
                if (!t.isLoading && !t.isLoaded) {
                    switch (((t.isLoading = !0), a.trigger("beforeLoad", t), (e = t.type), (o = t.$slide), o.off("refresh").trigger("onReset").addClass(t.opts.slideClass), e)) {
                        ...
                        case "video":
                            a.setContent(
                                t,
                                '<video class="fancybox-video" controls controlsList="nodownload"><source src="' + t.src + '" type="' + t.opts.videoFormat + "\">Your browser doesn't support HTML5 video</video"
                            );
                            break;
                        case "inline":
            ...
            setContent: function (t, e) {
                ...
                o.isClosing ||
                    ...
                    l(e) && e.parent().length
                        ...
                        : t.hasError ||
                          ("string" === n.type(e) && ((e = n("<div>").append(n.trim(e)).contents()), 3 === e[0].nodeType && (e = n("<div>").html(e))), t.opts.filter && (e = n("<div>").html(e).find(t.opts.filter))),
                        ...
                        : (p.removeEvents(),
                          ...
                          "zoom" === o
                              ? (n.fancybox.stop(a),
                                ...
                                !0)
                              : (o && i ? (t === !0 ? setTimeout(g, i) : n.fancybox.animate(h.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + o, i, g)) : g(),
                                !0)))
                );
            },
            cleanUp: function (t) {
                    ...
                    if (((i.realPoints = i.startPoints = a(o)), i.startPoints.length)) {
                        ...
                        (n.fancybox.isMobile && (l(c) || l(c.parent()))) || o.preventDefault(),
                            (1 === i.startPoints.length || u.hasError) &&
                                (i.instance.canPan() ? (n.fancybox.stop(i.$content), i.$content.css("transition-duration", ""), (i.isPanning = !0)) : (i.isSwiping = !0),
